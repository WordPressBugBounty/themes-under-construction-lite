        ...
        <div class="header_top row">      
            ...
            <div class="header_right headercommon">
                <div class="contact-info">
                    ...
                    <?php if (!empty($under_construction_lite_phone)) { ?>
                        <span class="info headerphone"><span class="fa fa-phone"></span>&nbsp;&nbsp;<a href="tel:<?php echo esc_attr($under_construction_lite_phone); ?>"><?php echo esc_html($under_construction_lite_phone); ?></a></span>
                    <?php } ?>           

                    <?php $under_construction_lite_email = get_theme_mod('under_construction_lite_email'); ?>
                    <?php if (!empty($under_construction_lite_email)) { ?>
                        <span class="info headeremail"><span class="fa fa-envelope"></span>&nbsp;&nbsp;<a href="mailto:<?php echo esc_attr($under_construction_lite_email); ?>"><?php echo esc_html(sanitize_email($under_construction_lite_email)); ?></a></span>
                    <?php } ?>
